...
#     print("Iam authenticated !!________1___")
...
#         return response
#     print("Iam authenticated !!______2_____") 
#     def process_request(self, request):
        
#         print("Iam authenticated !!______3_____")
#         # Timeout is done only for authenticated logged in users.
#         if request.user.is_authenticated:
#             print("Iam authenticated !!______44____")
#             print("Iam authenticated !!")
#             current_datetime = datetime.datetime.now()
#             print(request.session)
                
#                 # Timeout if idle time period is exceeded.
#             if request.session.has_key('last_activity') and (current_datetime - request.session['last_activity']).seconds > settings.SESSION_IDLE_TIMEOUT:
#                 print("it works !!!!!!!!")
#                 logout(request)
